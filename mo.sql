...
CREATE TABLE IF NOT EXISTS `mydb`.`movimiento` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_movimiento_artefacto1_idx` (`artefacto_id` ASC),
  CONSTRAINT `fk_movimiento_artefacto1`
...
-- -----------------------------------------------------
-- Table `mydb`.`estado_has_artefacto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`estado_has_artefacto` (
